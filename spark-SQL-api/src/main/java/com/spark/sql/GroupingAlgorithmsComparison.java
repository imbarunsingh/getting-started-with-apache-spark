...
// Comparing performance if SQL vs Java APi used in Spark SQL code
public class GroupingAlgorithmsComparison {
	public static void main(String[] args) {
		...
		groupedResultUsingJavaAPI.explain();
